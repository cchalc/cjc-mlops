...
[ML Config](../cjc_mlops/terraform/README.md) guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore .mlops-setup-scripts cjc_mlops/terraform/README.md
...
We recommend including all files outside of `cjc_mlops/terraform` in this PR:
...
Follow the instructions in [cjc_mlops/terraform/README.md](../cjc_mlops/terraform/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../cjc_mlops/terraform/README.md) to propose, test, and deploy
