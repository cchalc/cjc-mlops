...
# It is configured and can be executed as a training-job.tf job defined under ``cjc_mlops/terraform``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"//cjc_mlops-{env}/cjc_mlops-experiment-test",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "cjc_mlops-model-test", label="Model Name"
)
